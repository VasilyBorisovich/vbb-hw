package com.vbb.bot.basebotmodule.api.methods;

import com.vbb.bot.basebotmodule.api.methods.administration.*;
import com.vbb.bot.basebotmodule.api.methods.answerqueries.*;
import com.vbb.bot.basebotmodule.api.methods.games.*;
import com.vbb.bot.basebotmodule.api.methods.info.*;
import com.vbb.bot.basebotmodule.api.methods.invoices.CreateInvoiceLinkMethod;
import com.vbb.bot.basebotmodule.api.methods.invoices.SendInvoiceMethod;
import com.vbb.bot.basebotmodule.api.methods.other.*;
import com.vbb.bot.basebotmodule.api.methods.polls.SendPollMethod;
import com.vbb.bot.basebotmodule.api.methods.polls.StopPollMethod;
import com.vbb.bot.basebotmodule.api.methods.send.*;
import com.vbb.bot.basebotmodule.api.methods.stickers.*;
import com.vbb.bot.basebotmodule.api.methods.updates.*;
import com.vbb.bot.basebotmodule.api.methods.updatingmessages.*;
